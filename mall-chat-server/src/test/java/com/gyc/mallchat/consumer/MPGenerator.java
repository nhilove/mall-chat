...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/mall-chat-server/src/main/java");
        //设置作者名字
        ...
        packageConfig.setParent("com.gyc.mallchat.consumer.user");//自定义包的路径
...
//        strategyConfig.setTablePrefix("t_");
        ...
        strategyConfig.setInclude(
                "user_apply","user_friend","secure_invoke_record"
        );
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("20020109gyc");
        dataSourceConfig.setUrl("jdbc:mysql://110.42.252.216:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
