...
public class WxPortalController {
    ...
    @GetMapping("/test")
    public String wx(@RequestParam Integer code) throws WxErrorException {
        WxMpQrCodeTicket qrCodeTicket = wxMpService.getQrcodeService().qrCodeCreateTmpTicket(code, 100000);
    ...
    public RedirectView callBack(@RequestParam String code) throws WxErrorException {
        ...
        WxOAuth2UserInfo userInfo = wxMpService.getOAuth2Service().getUserInfo(token, "zh-CN");
        //用户授权
